#############################################################################
# Makefile for building: battalbot
# Generated by qmake (2.01a) (Qt 4.6.2) on: wt. kwi 27 19:06:23 2010
# Project:  battalbot.pro
# Template: app
# Command: /usr/bin/qmake -unix -o Makefile battalbot.pro
#############################################################################
...
INCPATH       = -I/usr/lib/qt4/mkspecs/linux-g++ -I. -I/usr/lib/qt4/include/QtCore -I/usr/lib/qt4/include/QtNetwork -I/usr/lib/qt4/include/QtGui -I/usr/lib/qt4/include/QtXml -I/usr/lib/qt4/include -I. -I.
LINK          = g++
LFLAGS        = -Wl,--as-needed -Wl,--no-undefined -Wl,-z,relro -Wl,-O1 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib -lqwt -lQtXml -L/usr/lib -lQtGui -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: battalbot.pro  /usr/lib/qt4/mkspecs/linux-g++/qmake.conf /usr/lib/qt4/mkspecs/common/g++.conf \
		/usr/lib/qt4/mkspecs/common/unix.conf \
		/usr/lib/qt4/mkspecs/common/linux.conf \
		/usr/lib/qt4/mkspecs/qconfig.pri \
		/usr/lib/qt4/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -unix -o Makefile battalbot.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/battalbot1.0.0 || $(MKDIR) .tmp/battalbot1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/battalbot1.0.0/ && $(COPY_FILE) --parents mainwindow.h irc.hpp reader.hpp battle.hpp .tmp/battalbot1.0.0/ && $(COPY_FILE) --parents images.qrc .tmp/battalbot1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp irc.cpp reader.cpp battle.cpp .tmp/battalbot1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/battalbot1.0.0/ && (cd `dirname .tmp/battalbot1.0.0` && $(TAR) battalbot1.0.0.tar battalbot1.0.0 && $(COMPRESS) battalbot1.0.0.tar) && $(MOVE) `dirname .tmp/battalbot1.0.0`/battalbot1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/battalbot1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_irc.cpp moc_reader.cpp moc_battle.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_irc.cpp moc_reader.cpp moc_battle.cpp
moc_mainwindow.cpp: irc.hpp \
		reader.hpp \
		battle.hpp \
		mainwindow.h
...
moc_irc.cpp: irc.hpp
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) irc.hpp -o moc_irc.cpp

moc_reader.cpp: reader.hpp
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) reader.hpp -o moc_reader.cpp

moc_battle.cpp: battle.hpp
	/usr/lib/qt4/bin/moc $(DEFINES) $(INCPATH) battle.hpp -o moc_battle.cpp
